...
An example in chucK is [here]({% post_url 2024-06-27-mensurationcanon_example_chuck %}).
An example in Tone.js is [here]({% post_url 2024-06-28-mensurationcanon_example_tonejs %}).
